...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(sydney));
        ...
        cluster = new ClusterManager<MarkerModel>(this, mMap);
...
//        mMap.animateCamera(CameraUpdateFactory.newLatLngBounds(bounds, width, height, padding));
    ...
    private void locationPermission() {
        ...
        if (EasyPermissions.hasPermissions(MapsActivity.this, perms)) {
            ...
            EasyPermissions.requestPermissions(MapsActivity.this, "Minta Ijin",
                    RC_LOCATION, perms);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        EasyPermissions.onRequestPermissionsResult(requestCode, permissions, grantResults, MapsActivity.this);
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            // TODO: Consider calling
            //    ActivityCompat#requestPermissions
            // here to request the missing permissions, and then overriding
...
//                                 });
                                 ...
                                 Toast.makeText(MapsActivity.this, "Response Not Successful ", Toast.LENGTH_SHORT).show();
                             }
                         }

                         @Override
                         public void onFailure(Call<ResponseModel> call, Throwable t) {
                             Toast.makeText(MapsActivity.this, "Response Failure : " + t.getMessage(), Toast.LENGTH_SHORT).show();
                         }
                     }
        );
    }
